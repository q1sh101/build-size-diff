...
4. Saves as baseline artifact (GitHub Artifacts API, 90-day retention)
...
**Performance:** Typical workflow overhead: 8-12 seconds (build time excluded). Compression runs in parallel - handles massive projects effortlessly.
...
- **90-day baseline retention** - GitHub artifacts expire automatically
